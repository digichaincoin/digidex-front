...
import {
  fetchOverviewTvl,
  fetchOverviewVolume,
  fetchOverviewDigichainDistribution,
...
export const useFetchOverviewDigichainDistribution = () => {
  const dispatch = useAppDispatch();
  const { slowRefresh } = useRefresh();

  useEffect(() => {
    dispatch(fetchOverviewDigichainDistribution());
  }, [slowRefresh, dispatch]);
  return useSelector(
    (state: State) => state.protocolDashboard.overviewDigichainDistribution
  );
};
...
export const useFetchOverviewProtocolMetrics = () => {
  ...
  return useSelector(
    (state: State) => state.protocolDashboard.overviewProtocolMetrics
  );
};
...
export const useFetchOverviewMcapTvlRatio = () => {
  ...
  return useSelector(
    (state: State) => state.protocolDashboard.overviewMcapTvlRatio
  );
};
...
export const useFetchTreasuryAssetOverview = () => {
  ...
  return useSelector(
    (state: State) => state.protocolDashboard.treasuryAssetOverview
  );
};
...
export const useFetchTreasuryBreakdown = () => {
  ...
  return useSelector(
    (state: State) => state.protocolDashboard.treasuryBreakdown
  );
};
