...
export const getTreasuryAssetOverview = async () => {
  try {
    ...
    const response = await axios.get(
      `${apiBaseUrl}/dashboard/treasury/asset-overview`
    );
    const data = await response.data;
    if (data.statusCode === 500) {
      return null;
...
export const getTreasuryHistory = async () => {
  try {
    ...
    const response = await axios.get(
      `${apiBaseUrl}/dashboard/treasury/history`
    );
    const data = await response.data;
    if (data.statusCode === 500) {
      return null;
...
export const getOverviewProtocolMetrics = async () => {
  try {
    ...
    const response = await axios.get(
      `${apiBaseUrl}/dashboard/overview/protocol-metrics`
    );
    const data = await response.data;
    if (data.statusCode === 500) {
      return null;
...
export const getOverviewMcapTvlRatio = async () => {
  try {
    ...
    const response = await axios.get(
      `${apiBaseUrl}/dashboard/overview/mcap-tvl-ratio`
    );
    const data = await response.data;
    if (data.statusCode === 500) {
      return null;
...
export const getOverviewDigichainDistribution = async () => {
  try {
    axiosRetry(axios, {
      retries: 5,
      retryCondition: () => true,
    ...
    const response = await axios.get(
      `${apiBaseUrl}/dashboard/overview/digichain-distribution`
    );
    const data = await response.data;
    if (data.statusCode === 500) {
      return null;
