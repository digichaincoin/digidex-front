...
import getTreasuryBreakdown, {
  getOverviewDigichainDistribution,
...
export const statsSlice = createSlice({
  ...
  reducers: {
    ...
    setOverviewDigichainDistribution: (state, action) => {
      state.overviewDigichainDistribution = action.payload;
    },
...
export const {
  ...
  setOverviewDigichainDistribution,
...
export const fetchOverviewDigichainDistribution = () => async (dispatch) => {
  const data = await getOverviewDigichainDistribution();
  dispatch(setOverviewDigichainDistribution(data));
};
