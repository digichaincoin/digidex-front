import { ChainId, Token } from "@digi.swap/sdk";
import { Tags, TokenInfo, TokenList } from "@uniswap/token-lists";
import { useMemo } from "react";
import { useSelector } from "react-redux";
import { createSelector } from "@reduxjs/toolkit";
import { fromPairs, groupBy, uniqBy } from "lodash";
import DEFAULT_TOKEN_LIST from "@digidexfinance/token-lists/lists/digidex.json";
import {
...
function combineMaps(
  ...
  return {
    ...
    [ChainId.MATIC_TESTNET]: {
      ...map1[ChainId.MATIC_TESTNET],
      ...map2[ChainId.MATIC_TESTNET],
    }, // matic testnet
