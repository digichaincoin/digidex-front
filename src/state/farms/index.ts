...
export const updateFarmUserAllowances =
  ...
  async (dispatch, getState) => {
    ...
    dispatch(
      updateFarmUserData({ pid, field: "allowance", value: allowances[pid] })
    );
  };
...
export const updateFarmUserTokenBalances =
  ...
  async (dispatch, getState) => {
    const farms = getState().farms.data;
    const tokenBalances = await fetchFarmUserTokenBalances(
      chainId,
      account,
      farms
    );
...
export const updateFarmUserStakedBalances =
  ...
  async (dispatch, getState) => {
    const farms = getState().farms.data;
    const stakedBalances = await fetchFarmUserStakedBalances(
      chainId,
      account,
      farms
    );
...
export const updateFarmUserEarnings =
  ...
  async (dispatch, getState) => {
    ...
    dispatch(
      updateFarmUserData({ pid, field: "earnings", value: pendingRewards[pid] })
    );
  };
