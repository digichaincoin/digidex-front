...
export const harvestMaximizer = async (vaultApeContract: VaultDigiV2, pid) => {
  return vaultApeContract.harvestAll(pid).then((trx) => {
    return trx.wait();
  });
};

export const stakeVaultV1 = async (
  vaultApeContract: VaultDigiV1,
  pid,
  amount
) => {
...
export const vaultUnstakeV1 = async (
  vaultApeContract: VaultDigiV1,
  pid,
  amount
) => {
...
export const stakeVaultV2 = async (
  vaultApeContract: VaultDigiV2,
  pid,
  amount
) => {
...
export const vaultUnstakeV2 = async (
  vaultApeContract: VaultDigiV2,
  pid,
  amount
) => {
...
export const vaultUnstakeAll = async (
  vaultApeContract: VaultDigiV1 | VaultDigiV2,
  pid
) => {
...
export const miniChefStake = async (
  miniChefContract: MiniDigiV2,
  pid,
  amount,
  account
) => {
...
export const miniChefHarvest = async (
  miniChefContract: MiniDigiV2,
  pid,
  account
) => {
...
export const miniChefUnstake = async (
  miniChefContract: MiniDigiV2,
  pid,
  amount,
  account
...
export const userBuyBill = async (
  billContract: Bill,
  user: string,
  lpAmount: string,
  maxPrice: string
...
export const userTransferBillNft = async (
  billNft: BillNft,
  billId: string,
  fromAddress: string,
  toAddress: string
) => {
  return billNft["safeTransferFrom(address,address,uint256)"](
    fromAddress,
    toAddress,
    billId
  ).then((trx) => {
