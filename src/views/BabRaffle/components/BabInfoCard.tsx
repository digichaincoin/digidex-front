...
import { Button, Flex, Spinner, Text } from "@digi.swap/uikit";
      ...
      >
        ...
        >
          ...
          >
            {isMobile
              ? t("ApeSwap x BAB")
              : t("ApeSwap x Binance Account Bound Token")}
          </Text>
        ...
        <Flex sx={{ flexDirection: "column", gap: "10px" }}>
          ...
          <NumberedList
            ...
            description="Mint your ApeSwap BAB Club Token to be eligible for the Non Fungible Digichain NFT giveaway."
            t={t}
          />
          <NumberedList
            title="3- Good Luck! ✅"
