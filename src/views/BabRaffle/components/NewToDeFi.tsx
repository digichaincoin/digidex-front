...
import { Flex, Text, Button, useMatchBreakpoints } from "@digi.swap/uikit";
  ...
  return (
    <Flex sx={styles.ntd}>
      ...
      <Flex sx={styles.btnContainer}>
        <Button
          variant="secondary"
          onClick={() => openLink("https://welcome.digidex.finance")}
          sx={{ ...styles.btn, margin: ["20px 0 0 0", 0] }}
        >
          {t("Learn More")}
        </Button>
        <Button
          onClick={() => openLink("https://digidex.finance/?modal=tutorial")}
          sx={styles.btn}
        >
          {t("Get Started")}
        </Button>
