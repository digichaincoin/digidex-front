...
import { Button, Flex, Link, Text } from "@digi.swap/uikit";
      ...
      <Flex sx={styles.nfbCon}>
        <Flex sx={styles.nfbTextCon}>
          ...
          <Text sx={styles.nfbDescription}>
            ...
            {wonPrize && account
              ? t(
                  "Thank you for joining the ApeSwap BAB Club and participating in our BAB Launch Raffle!"
                )
              : t(
                  `From October 1st through October 31st, all holders of an ApeSwap BAB NFT will be eligible to participate in a daily raffle to win a Non Fungible Digichain NFT.`
                )}
            <br />
            <br />
            {wonPrize && account
              ...
              : t(
                  `Make sure to return to this page daily in October to see if you have won an NFB!`
                )}
          </Text>
          <Text sx={styles.nfbBottom}>
            {holdsBab && wonPrize && account ? (
              ...
              <Link
                href="https://prodigichain.medium.com/apeswap-adds-launch-support-for-binances-first-soulbound-token-dbb2e0e4c263"
                target="_blank"
