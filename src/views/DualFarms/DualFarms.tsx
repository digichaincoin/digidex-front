    ...
    switch (sortOption) {
      ...
      case "stables":
        return farms
          .filter(
            (farm) =>
              STABLES.includes(farm.stakeTokens.token0.symbol) &&
              STABLES.includes(farm.stakeTokens.token1.symbol)
          )
          .slice(0, numberOfFarmsVisible);
      case "apr":
      ...
      case "liquidity":
        return orderBy(
          farms,
          (farm: DualFarm) => parseFloat(farm.totalStaked),
          "desc"
        ).slice(0, numberOfFarmsVisible);
      default:
        return farmOrderings
