      ...
      cardContent: (
        <>
          ...
          <ListViewContent
            ...
            height={52.5}
            toolTip={t(
              "This is how long it will take for all tokens in the Bill to fully vest."
            )}
            toolTipPlacement={isMobile ? "bottomRight" : "bottomLeft"}
            toolTipTransform={
              isMobile ? "translate(13%, 0%)" : "translate(39%, 0%)"
            }
          />
          {!isMobile && (
            <>
        ...
        >
          {account ? (
            <BillModal
              ...
              buyFlag
              disabled={
                !bill.discount || bill.discount.includes("NaN") || disabled
              }
            />
          ) : (
            <UnlockButton />
