import { useModal, WarningIcon } from "@digi.swap/uikit";
import {
  Checkbox,
  Flex,
  Modal,
...
const WarningModal: React.FC<TransferBillModalProps> = ({
  onDismiss,
  bill,
}) => {
        ...
        <Flex ml="30px" flexDirection="column">
          <Flex>
            <Text style={{ fontWeight: 600 }}>
              The {bill.earnToken.symbol} you recieve from this{" "}
              {bill.token.symbol}-{bill.quoteToken.symbol} Treasury Bill at a{" "}
