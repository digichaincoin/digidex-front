...
import { Modal, ModalProvider } from "@digi.swap/uikit";
...
const BuyBillModalView: React.FC<BillModalProps> = ({ onDismiss, bill }) => {
  ...
  const discountEarnTokenPrice =
    earnTokenPrice - earnTokenPrice * (parseFloat(discount) / 100);
                  ...
                  <Flex alignItems="center">
                    ...
                    <Flex flexDirection="column">
                      ...
                      <TopDescriptionText ml="12px">
                        {t("Vesting Term")}:{" "}
                        {`${vestingTime.days}d, ${vestingTime.minutes}h, ${vestingTime.seconds}m`}
                      </TopDescriptionText>
                    </Flex>
                  </Flex>
                </BillTitleContainer>
                  ...
                  <Flex style={{ width: "250px" }}>
                    <TopDescriptionText>
                      ...
                      <span style={{ textDecoration: "line-through" }}>
                        ${getFirstNonZeroDigits(earnTokenPrice)}
                      </span>
                    </TopDescriptionText>
                  </Flex>
                  <Flex alignItems="center">
                    ...
                    <StyledHeadingText ml="10px" bold>
                      ${getFirstNonZeroDigits(discountEarnTokenPrice)} (
                      {discount}% Discount)
                    </StyledHeadingText>
                  </Flex>
                </Flex>
