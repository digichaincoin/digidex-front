...
import { Flex, Svg, Text } from "@digidexfinance/uikit";
    ...
    <>
      <TableHeading>
        ...
        >
          {t("Vesting Time")}
          <Tooltip
            content={t("Time remaining until an asset is fully vested.")}
          >
        ...
        <StyledTable>
          ...
          >
            {vestedProducts.map((vesting) => {
              const timeUntilEnd =
                vesting.vestingTimeRemaining > 0
                  ? getTimePeriods(vesting.vestingTimeRemaining, true)
                  : null;
