...
export const ProjectedEarnings: React.FC = () => {
  ...
  const handleActiveTab = (el: HTMLDivElement, tab: string) => {
    ...
    el.focus();
    setSelectedTab(tab);
    setFilteredProjected(
      projectedData.find((product) => product.type === tab.toLowerCase())
    );
  };
  ...
  const handleNavigateRight = (currentTab: string) => {
    ...
    if (currentIndex < 5)
      handleActiveTab(
        refs.current[currentIndex + 1],
        tabOptions[currentIndex + 1]
      );
  };
    ...
    <>
      <FlexScroll>
        <ChevronLeft
          strokeWidth={3}
          cursor="pointer"
          onClick={() => handleNavigateLeft(selectedTab)}
        />
        <ScrollMenu>
        ...
        <ChevronRight
          strokeWidth={3}
          cursor="pointer"
          onClick={() => handleNavigateRight(selectedTab)}
        />
      </FlexScroll>
            ...
            <tr>
              ...
              <td>
                <CardValue
                  ...
                  decimals={2}
                  value={
                    filteredProjected?.roi.daily > 10000
                      ? 10000
                      : filteredProjected?.roi.daily ?? 0
                  }
            ...
            <tr>
              ...
              <td>
                <CardValue
                  ...
                  decimals={2}
                  value={
                    filteredProjected?.roi.weekly > 1000
                      ? 1000
                      : filteredProjected?.roi.weekly ?? 0
                  }
              ...
              <td>
                <CardValue
                  ...
                  prefix={
                    filteredProjected?.projectedEarnings.weekly > 1e4
                      ? "> $"
                      : "$"
                  }
                />
            ...
            <tr>
              ...
              <td>
                <CardValue
                  ...
                  decimals={2}
                  value={
                    filteredProjected?.roi.monthly > 1e4
                      ? 1e4
                      : filteredProjected?.roi.monthly ?? 0
                  }
                  prefix={
            ...
            <tr>
              ...
              <td>
                <CardValue
                  ...
                  decimals={2}
                  value={
                    filteredProjected?.roi.yearly > 1e5
                      ? 1e5
                      : filteredProjected?.roi.yearly ?? 0
                  }
