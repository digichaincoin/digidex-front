...
import { Flex, LinkExternal, Text } from "@digidexfinance/uikit";
...
export const ProductCardHeader: React.FC<ProductCardHeaderProps> = ({
  ...
  const displayTitle = (type: ProductType) => {
    switch (type) {
      case "farms":
        return "DIGICHAIN Farms";

      case "pools":
        return "Staking Pools";

      case "maximizers":
        return "DIGICHAIN Maximizers BOOST";
      ...
      case "iaos":
        return "Initial Digui Offerings";
    ...
    <StyledDiv>
      <Flex alignItems="center" justifyContent="space-between">
        <LinkExternal
          href={
            type === "lending"
              ? "https://lending.digidex.finance"
              : `https://digidex.finance/${productLink[type]}`
          }
        >
