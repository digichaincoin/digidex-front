    ...
    return (
      <>
        ...
        <Flex
          ...
          style={{
            width: "100%",
            marginLeft: `${productType === "lending" ? "-64px" : 0}`,
          }}
        >
          <Text style={{ maxWidth: "150px", width: "100%" }}>
            {displaySecondLabel(productType)}
          </Text>
          {productType === "lending" ? (
            <Text style={{ maxWidth: "150px", width: "100%" }}>Borrowed</Text>
          ) : null}
          {productType === "lending" ? (
            <>
              <Text style={{ maxWidth: "100px", width: "100%" }}>
                Supply APY
              </Text>
              <Text style={{ maxWidth: "100px", width: "100%" }}>
                Borrow APY
            ...
            <Text style={{ maxWidth: "80px", width: "100%" }}>
              {productType === "maximizers" ? "APY" : "APR"}
            </Text>
          )}
      ...
      return (
        <LargeDiv style={{ marginLeft: "-64px" }}>
          <CardValue
            fontSize="16px"
            fontWeight={700}
            value={position.supplyBalance}
            suffix={position.tokens.token1}
          />
          <CardValue
            fontSize="12px"
            fontWeight={500}
        ...
        <div>
          ...
          {position.isAuto ? (
            ...
            <CardValue
              ...
              fontWeight={700}
              suffix={
                position.rewardToken ? position.rewardToken.symbol : "DIGICHAIN"
              }
            />
          )}
            ...
            <CardValue
              ...
              suffix={
                position.rewardToken
                  ? position.rewardToken.symbol.toUpperCase()
                  : "DIGICHAIN"
              }
            />
            {position.secondaryRewardBalance ? (
            ...
            <CardValue
              ...
              value={
                position.rewardToken
                  ...
                  ? position.rewardBalance * digichainPrice +
                    position.secondaryRewardValue
                  : position.rewardBalance * digichainPrice
              }
              prefix="$"
  ...
  return (
    <CardInfo>
      ...
      <Content isOpen={isOpen}>
        {isMobile ? null : (
          <TableHeader>{displayLabels(productData.type)}</TableHeader>
        )}
        <div
          style={{
            width: "100%",
                  ...
                  .map((position) => {
                    return {
                      ...
                      cardContent: isMobile ? null : (
                        <>
                          {isBillsOrIAOs
                            ? displayVestingRemainingSection(position)
                            : displayBalanceSection(position)}
                          {productData.type === "lending"
                            ? displayBorrowedSection(position)
                            : null}
