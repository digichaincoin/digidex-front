import { BaseLayout, Card, Flex, Text } from "@digidexfinance/uikit";
...
export const Header = styled.div`
  ...
  background-image: ${({ theme }) =>
    theme.isDark
      ? "url(/images/new-banners/stats-banner-night.png)"
      : "url(/images/new-banners/stats-banner-day.png)"};
...
export const TranslucidCard = styled(Card)`
  ...
  height: 90px;
  background: ${({ theme }) =>
    theme.isDark ? rgba(11, 11, 11, 0.4) : rgba(253, 251, 245, 0.2)} !important;
