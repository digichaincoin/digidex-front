...
import { Image, Flex, Text } from "@digidexfinance/uikit";
...
interface BillProps {
  ...
  imageUrl: string;
  name: string;
  type: "Digichain" | "Jungle";
  tokens: { token1: string; token2: string; token3: string };
  value: number;
  timeRemaining: string;
}

export const BillCard: React.FC<BillProps> = ({
  imageUrl,
  name,
  type,
  tokens,
      ...
      >
        ...
        <div style={{ padding: "20px", width: "100%" }}>
          ...
          >
            ...
            />
            <div>
              <StyledText marginTop="0 !important">
