...
import { Text, Flex, Skeleton } from "@digi.swap/uikit";
...
import {
  useFetchHomepageServiceStats,
  useHomepageServiceStats,
} from "state/hooks";
    ...
    return (
      <>
            ...
            return (
              <a href={stat?.link} rel="noopener noreferrer" key={stat?.apr}>
                ...
                >
                  ...
                  >
                    <Text
                      sx={{ width: "100%", color: "white", fontWeight: 700 }}
                    >
                      {name}
                    </Text>
                    {id === "lendingDetails" ? (
                      ...
                      >
                        ...
                        <span
                          style={{
                            color: stat.discount > 0 ? "white" : "#DF4141",
                          }}
                        >
        ...
        <a href={link} rel="noopener noreferrer">
          ...
          >
            <Text
              sx={{ color: "primaryBright", fontSize: "16px", fontWeight: 700 }}
            >
              {t("See All")} {">"}
            </Text>
          </Flex>
              ...
              return (
                <Flex
                  sx={{
                    ...
                    background:
                      (i === activeSlide &&
                        "linear-gradient(53.53deg, #a16552 15.88%, #e1b242 92.56%)") ||
                      "white4",
                  }}
