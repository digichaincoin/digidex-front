...
import {
  useFetchHomepageLaunchCalendar,
...
const LaunchCalendar: React.FC = () => {
  ...
  const sortLaunch = launchCal?.filter(
    (launch) => new Date(launch.launchTime) > today
  );
                    ...
                    >
                      <LaunchCard>
                        ...
                        >
                          ...
                          {launch?.image2 && (
                            <CalendarImg image={launch.image2?.url} />
                          )}
                        </Flex>
                        <Flex
                          mt="10px"
