  ...
  return (
    <>
      <Container>
        <Banner
          banner="iao"
          link="https://digichain.gitbook.io/digidex-finance/product-and-features/raise/initial-ape-offerings-iaos"
        ...
        {tabOption === "past" && (
          <IfoPastProjectSwiper onSelectProject={setProjectId} />
        )}
        <IfoTabButtons
          onSelect={handleTabSelectionChange}
