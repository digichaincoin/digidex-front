...
const Icon = ({ name }: Props) => {
  ...
  return (
    <IconBox>
      <CenteredImage
        src={`/images/ifos/${name}-${isDark ? "dark" : "light"}.svg`}
        alt={name}
      />
    </IconBox>
  );
      ...
      <Frame>
        <FeatureBox>
          ...
          <StyledText textAlign="center">
            {t(
              "We thoroughly vet applicants to choose projects we believe in as long term partners"
            )}
          </StyledText>
        </FeatureBox>
        <FeatureBox>
        ...
        <FeatureBox>
          ...
          <StyledText textAlign="center">
            {t(
              "These projects are meant to be unique and push the boundaries of crypto forward"
            )}
          </StyledText>
        </FeatureBox>
      </Frame>
