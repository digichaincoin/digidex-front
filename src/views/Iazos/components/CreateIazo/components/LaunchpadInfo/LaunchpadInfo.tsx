...
const listOfFaqs: (t: ContextApi["t"]) => any[] = (t) => [
  {
    ...
    description: (
      <>
        {t("Read the")}{" "}
        <FaqLink
          href="https://digichain.gitbook.io/digidex-finance/product-information/self-serve-iaos-ss-iaos/how-to-create-an-ss-iao"
          target="_blank"
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <FaqLink
          href="https://prodigichain.medium.com/self-serve-iaos-best-practices-on-how-to-attract-apes-9610b370b448"
          target="_blank"
          rel="noopener noreferrer"
        >
          {t("our guide")}
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <FaqLink
          href="https://digichain.gitbook.io/digidex-finance/product-information/self-serve-iaos-ss-iaos/ss-iao-faq"
          target="_blank"
          rel="noopener noreferrer"
        >
          {t("FAQ")}
...
export default function LuanchpadInfo(): JSX.Element {
  ...
  return (
    <LaunchPadInfoWrapper>
      ...
      <MoreInfo
        href="https://digichain.gitbook.io/digidex-finance/product-information/self-serve-iaos-ss-iaos"
        target="_blank"
        rel="noopener noreferrer"
      >
        {t("DOCUMENTATION")} {">"}
