...
import { useMatchBreakpoints, Checkbox } from "@digidexfinance/uikit";
...
const PresaleDetails: React.FC<PresaleDataProps> = ({
  pairTokenDetails,
  onChange,
}) => {
  ...
  const { tokenSymbol, quoteToken, userBalance, tokenDecimals } =
    pairTokenDetails;
  ...
  return (
    <>
      <LaunchPadInfoWrapper>
        <StyledHeader>
          {t("How many %symbol% are up for presale?", { symbol: tokenSymbol })}
        </StyledHeader>
        <TokenInput
          onChange={(e) =>
            setTokenDetails({
              ...tokenDetails,
              tokensForSale: e.currentTarget.value,
            })
          }
          size="lg"
        ...
        <TokenInput
          onChange={(e) =>
            setTokenDetails({
              ...tokenDetails,
              pricePerToken: e.currentTarget.value,
            })
          }
        ...
        <TokenInput
          onChange={(e) =>
            setTokenDetails({
              ...tokenDetails,
              limitPerUser: e.currentTarget.value,
            })
          }
        ...
        <TokenInput
          onChange={(e) =>
            setTokenDetails({ ...tokenDetails, softcap: e.currentTarget.value })
          }
          title={t("Softcap")}
          quoteTokenSymbol={quoteToken}
          mr={marginRight}
          ...
          max={
            ...
            parseFloat(tokenDetails?.pricePerToken)
          }
          ...
          <CheckboxContainer>
            <Checkbox
              ...
              onChange={() =>
                setTokenDetails({
                  ...tokenDetails,
                  burnRemains: !tokenDetails?.burnRemains,
                })
              }
            />
          </CheckboxContainer>
