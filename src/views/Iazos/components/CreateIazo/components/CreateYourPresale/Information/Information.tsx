  ...
  return (
    <>
      ...
      <InputWrapper>
        <TextInput
          onChange={(e) =>
            setInformation({ ...information, website: e.currentTarget.value })
          }
        ...
        <TextInput
          onChange={(e) =>
            setInformation({
              ...information,
              whitepaper: e.currentTarget.value,
            })
          }
          backgroundColor={bgColor}
          size={inputSize}
        ...
        <TextInput
          onChange={(e) =>
            setInformation({ ...information, twitter: e.currentTarget.value })
          }
          backgroundColor={bgColor}
          size={inputSize}
          height="sm"
        ...
        <TextInput
          onChange={(e) =>
            setInformation({ ...information, telegram: e.currentTarget.value })
          }
          backgroundColor={bgColor}
          size={inputSize}
          height="sm"
        ...
        <TextInput
          onChange={(e) =>
            setInformation({ ...information, medium: e.currentTarget.value })
          }
          backgroundColor={bgColor}
          size={inputSize}
          height="sm"
        ...
        <ImageUpload
          title={`${t("Token Logo")}:*`}
          onChange={(e) =>
            setInformation({ ...information, tokenLogo: e.imageFile })
          }
        />
      </InputWrapper>
    </>
