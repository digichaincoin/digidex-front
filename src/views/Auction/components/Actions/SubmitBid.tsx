...
const SubmitBid: React.FC<BidProps> = ({
  disabled,
  currentBid,
  nfaId,
  countdown,
    ...
    <StyledButton
      ...
      onClick={async () => {
        ...
        await onBid(currentBid, nfaId, auctionId).catch(() => {
          toastError(
            t("Bidding Error: It is likely you were outbid. Please try again.")
          );
        });
        setPendingTx(false);
      }}
    ...
    <StyledButton
      ...
      onClick={async () => {
        ...
        await onNextAuction(nfaId).catch(() => {
          toastError(
            t("Transaction Error: Please attempt your transaction again.")
          );
        });
        setPendingTx(false);
      }}
