      ...
      <Container>
        <Flex alignItems="center" justifyContent="center">
          <Flex alignSelf="center" style={{ width: "1200px" }}>
            <Banner
              banner="auction"
              link="https://digichain.gitbook.io/digidex-finance/product-and-features/collect/nfa-auction-house"
              title={t("Nfa Auction")}
        ...
        <PageWrapper>
          <MoreInfoWrapper>
            <ButtonHolder>
              <a
                href="https://digichain.gitbook.io/digidex-finance/product-information/non-fungible-apes-nfas/nfa-auction-house"
                target="_blank"
          ...
          <SplitWrapper>
            <AuctionCardsWrapper>
              {auctions && <Positions auctions={auctions} />}
            </AuctionCardsWrapper>
          </SplitWrapper>
          {isDesktop && <History />}
        </PageWrapper>
