...
const Header = styled.div<{ banner: string }>`
  ...
  background-image: ${(props) =>
    props.banner
      ? `url(/images/burning-games/${props.banner})`
      : "url(/images/burning-games/burning.png)"};
  ...
  return (
    <ContainerPrincipal>
      <Header banner={banner}>
        <HeadingContainer>
          <StyledHeading as="h1">{t("DIGICHAIN Burns")}</StyledHeading>
      ...
      <StyledPage width="1130px">
        ...
        <Cards isMobile={!isDesktop}>
          {data.map((i, index) => index > 0 && <CardBurningGame game={i} />)}
        </Cards>
      </StyledPage>
    </ContainerPrincipal>
  );
