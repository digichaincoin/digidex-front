...
import { Flex, Heading, Text } from "@digidexfinance/uikit";
...
const PoolFinishedSash = styled.div`
  @media (max-width: 1000px) {
    background-image: url("/images/gdigiSash.svg");
...
const CardHeading: React.FC<ExpandableSectionProps> = ({
  ...
  const cardHeaderButton = () => {
    ...
    if (!allowance) {
      return (
        <ApprovalAction
          nfaStakingPoolContract={pool.contractAddress[CHAIN_ID]}
          sousId={sousId}
          isLoading={isLoading}
        />
      );
  ...
  return (
    <Flex>
      ...
      <StyledFlexContainer>
        ...
        {stakeToken === "GDIGI" && <PoolFinishedSash />}
      </StyledFlexContainer>
    </Flex>
  );
};
