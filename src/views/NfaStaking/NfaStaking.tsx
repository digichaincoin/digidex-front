...
import { Text, Card, Checkbox } from "@digidexfinance/uikit";
import { partition } from "lodash";
import {
  useSetNfaStakingPools,
  usePollNfaStakingData,
  useNfaStakingPools,
} from "state/nfaStakingPools/hooks";
  ...
  const poolsToShow = () => {
    ...
    if (searchQuery) {
      ...
      chosenPools = chosenPools.filter((pool) =>
        `tier ${pool.tier}`.includes(lowercaseQuery)
      );
    }
    return chosenPools;
  };
  ...
  return (
    <>
      <StyledPage width="1130px">
        <Banner
          banner="nfa-staking"
          link="https://digichain.gitbook.io/digidex-finance/product-and-features/stake"
