...
const StakeAction: React.FC<StakeActionsProps> = ({
  ...
  const userStakedBalanceUsd = `$${(
    getBalanceNumber(new BigNumber(stakedBalance) || new BigNumber(0)) *
    lpValueUsd
  ).toFixed(2)}`;
  ...
  const displayGHCircular = () =>
    showGeneralHarvestModal &&
    showCircular(chainId, history, "?modal=circular-gh");
        ...
        await onUnstake(val)
          .then((resp) => {
            ...
            toastSuccess(
              ...
              <LinkExternal
                href={getEtherscanLink(trxHash, "transaction", chainId)}
              >
      ...
      return (
        <CenterContainer>
          <StyledButton
            ...
            endIcon={
              pendingDepositTrx && <AutoRenewIcon spin color="currentColor" />
            }
      ...
      <ActionContainer>
        ...
        <Flex>
          <SmallButton
            ...
            endIcon={
              pendingWithdrawTrx && <AutoRenewIcon spin color="currentColor" />
            }
          ...
          <SmallButton
            ...
            disabled={
              pendingDepositTrx || !new BigNumber(stakingTokenBalance)?.gt(0)
            }
          >
            <AddIcon
              color="white"
