...
const UtilitySlide: React.FC<UtilitySlidesProps> = ({
  action,
  icon,
  title,
  detail,
  ...
  return (
    <Flex
      sx={{
        ...
        background: isDark ? "#424242" : styles.bg1,
      }}
    >
      <a
        href={href ?? "#convert"}
      ...
      >
        <Flex
          sx={{
            ...styles.subContainer,
            background: isDark ? "#383838" : styles.bg2,
          }}
        >
          <Box sx={styles.box}>
          ...
          <Box
            sx={styles.box}
            style={{ paddingTop: "15px", minHeight: "80px" }}
          >
