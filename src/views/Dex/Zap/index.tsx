...
import { Flex, Link, Svg, Text } from "@digi.swap/uikit";
        ...
        <Flex sx={dexStyles.dexContainer}>
          ...
          <Flex sx={styles.liquidityContainer}>
            ...
            <ZapPanel
              ...
              onSelect={(currency0, currency1) =>
                handleCurrencySelect(Field.OUTPUT, [currency0, currency1])
              }
            ...
            <Flex sx={{ marginTop: "10px", justifyContent: "center" }}>
              <Link
                href="https://digichain.gitbook.io/liquidity"
                target="_blank"
                textAlign="center"
              >
                <Text
