  ...
  return (
    <Flex sx={{ flexDirection: "column", marginTop: "15px" }}>
      ...
      <Row>
        ...
        <StyledText>
          {liquidityProviderFee.toSignificant(3)}{" "}
          {currencyIn.currency.getSymbol(chainId)}
        </StyledText>
      </Row>
      <Row>
      ...
      <Row>
        ...
        <StyledText>
          {currencyOut1?.outputAmount
            ?.divide(currencyOut2?.outputAmount)
            .toSignificant(5)}
        </StyledText>
      </Row>
      <Row>
        ...
        <StyledText>
          {currencyOut2?.outputAmount
            ?.divide(currencyOut1?.outputAmount)
            .toSignificant(5)}
        </StyledText>
      </Row>
    </Flex>
