...
import { JSBI, Token, TokenAmount } from "@digi.swap/sdk";
    ...
    <>
      ...
      >
        <Flex sx={{ minWidth: "160px", justifyContent: "center" }}>
          <Box sx={{ margin: "3px" }}>
            <ServiceTokenDisplay
              token1={currencyIn?.currency?.getSymbol(chainId)}
              stakeLp={true}
              size={17}
            />
          </Box>
          ...
          <Box sx={{ margin: "3px" }}>
            <ServiceTokenDisplay
              token1={currencyOut1?.outputCurrency?.symbol}
              stakeLp={true}
              size={17}
            />
          </Box>
        ...
        <Flex sx={{ minWidth: "160px", justifyContent: "center" }}>
          ...
          <Box sx={{ margin: "3px" }}>
            <ServiceTokenDisplay
              token1={currencyOut2?.outputCurrency?.symbol}
              stakeLp={true}
              size={17}
            />
          </Box>
