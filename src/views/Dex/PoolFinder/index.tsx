...
import { Currency, ETHER, JSBI, TokenAmount } from "@digi.swap/sdk";
import { Text, useModal, Flex, Svg } from "@digi.swap/uikit";
      ...
      <Flex sx={{ flexDirection: "column" }}>
        <Flex sx={{ ...dexStyles.dexContainer }}>
          ...
          {currency0 && currency1 ? (
            ...
            <Flex sx={{ margin: "20px 0px", justifyContent: "center" }}>
              {prerequisiteMessage}
            </Flex>
          )}
          {/* <CurrencySearchModal
