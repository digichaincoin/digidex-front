...
import { Flex, Svg, Text } from "@digi.swap/uikit";
    ...
    >
      ...
      >
        <Flex sx={{ marginRight: "5px" }}>
          <Svg
            color={pathname.includes("/liquidity") ? "text" : "textDisabled"}
            icon="Positions"
            width="20px"
          />
        </Flex>
        <Text color={pathname.includes("/liquidity") ? "text" : "textDisabled"}>
          {t("Positions")}
        </Text>
      </Flex>
      ...
      <Flex as={Link} to="/zap" id="zap-link" sx={styles.liquiditySelector}>
        <Flex sx={{ marginRight: "5px" }}>
          <Svg
            color={pathname.includes("zap") ? "text" : "textDisabled"}
            icon="ZapIcon"
          />
        </Flex>
        <Text color={pathname.includes("zap") ? "text" : "textDisabled"}>
          {t("Zap")}
        </Text>
      </Flex>
      {chainId === ChainId.BSC ? (
        ...
        >
          <Flex sx={{ marginRight: "5px" }}>
            <Svg
              color={pathname.includes("migrate") ? "text" : "textDisabled"}
              icon="Migrate"
              width="20px"
            />
          </Flex>
          <Text color={pathname.includes("migrate") ? "text" : "textDisabled"}>
            {t("Migrate")}{" "}
          </Text>
        </Flex>
      ) : (
