...
import { Trade, TradeType } from "@digi.swap/sdk";
import {
...
import { Button, Text, Flex } from "@digi.swap/uikit";
...
export default function SwapModalFooter({
  ...
  const tradeInfoText =
    trade.tradeType === TradeType.EXACT_INPUT
      ? t(
          "Output is estimated. You will receive at least %amount% %symbol% or the transaction will be cancelled.",
          {
            amount,
            symbol,
          }
      ...
      : t(
          "Input is estimated. You will sell at most %amount% %symbol% or the transaction will be cancelled.",
          {
            amount,
            symbol,
          }
