...
const DexActions: React.FC<DexActionProps> = ({
  ...
  const sellingDigichain = inputCurrency === digichainToken;
  const displaySellCircular = () =>
    showSellModal && showCircular(chainId, history, "?modal=circular-sell");
      ...
      <Button
        ...
        onClick={() => {
          if (isExpertMode) {
            ...
            if (sellingDigichain) displaySellCircular();
            onPresentConfirmModal();
          }
        }}
        id="swap-button"
