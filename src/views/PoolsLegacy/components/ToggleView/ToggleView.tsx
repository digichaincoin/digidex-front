...
import { ListViewIcon, CardViewIcon, Flex } from "@digidexfinance/uikit";
  ...
  return (
    <StyledFlex>
      <StyledIconButton onClick={() => handleToggle(ViewMode.TABLE)}>
        <StyledListViewIcon
          color={viewMode === ViewMode.TABLE ? "yellow" : "textDisabled"}
        />
      </StyledIconButton>
      <StyledIconButton onClick={() => handleToggle(ViewMode.CARD)}>
        <StyledCardViewIcon
          color={viewMode === ViewMode.CARD ? "yellow" : "textDisabled"}
        />
      </StyledIconButton>
    </StyledFlex>
  );
