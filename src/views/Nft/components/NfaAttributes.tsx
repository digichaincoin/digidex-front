    ...
    <AttributesHolder>
      <ToolTip>
        <Attribute>
          ...
          <ToolTipText>
            {t("Occurance %occurance% of 1000", { occurance: base.occurance })}
          </ToolTipText>
        </Attribute>
      </ToolTip>
      <ToolTip>
        <Attribute>
          ...
          <ToolTipText>
            {t("Occurance %occurance% of 1000", { occurance: face.occurance })}
          </ToolTipText>
        </Attribute>
      </ToolTip>
      <ToolTip>
        <Attribute>
          ...
          <ToolTipText>
            {t("Occurance %occurance% of 1000", { occurance: frame.occurance })}
          </ToolTipText>
        </Attribute>
      </ToolTip>
      <ToolTip>
        <Attribute>
          ...
          <ToolTipText>
            {t("Occurance %occurance% of 1000", { occurance: mouth.occurance })}
          </ToolTipText>
        </Attribute>
      </ToolTip>
      <ToolTip>
        <Attribute>
          {eye.category}: {eye.id}
          <ToolTipText>
            {t("Occurance %occurance% of 1000", { occurance: eye.occurance })}
          </ToolTipText>
        </Attribute>
      </ToolTip>
      <ToolTip>
        <Attribute>
          {hat.category}: {hat.id}
          <ToolTipText>
            {t("Occurance %occurance% of 1000", { occurance: hat.occurance })}
          </ToolTipText>
        </Attribute>
      </ToolTip>
    </AttributesHolder>
