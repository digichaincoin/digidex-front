...
import { Button, Heading, Text } from "@digidexfinance/uikit";
      ...
      <Container>
        <StyledHero>
          ...
          <Heading as="h2" size="lg" color="secondary" mb="16px">
            {t("Trade in for DIGICHAIN, or keep for your collection!")}
          </Heading>
          <Text mb="24px">
            {t("Register your interest in winning an NFT below.")}
          </Text>
          <Cta>
            <Button
              as="a"
