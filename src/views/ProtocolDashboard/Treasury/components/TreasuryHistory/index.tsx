...
const TreasuryHistory: React.FC = () => {
  ...
  const totalApePol =
    treasuryHistory?.[treasuryHistory?.length - 1]?.digiPolValue;
  const totalPartnerPol =
    treasuryHistory?.[treasuryHistory?.length - 1]?.partnerPolValue;
  const totalTreasury =
    treasuryHistory?.[treasuryHistory?.length - 1]?.oppFundValue;
      ...
      >
        ...
        {totalApePol && totalTreasury && (
          <Text size="16px" weight={500}>
            $
            <CountUp
              end={totalApePol + totalTreasury + totalPartnerPol}
              decimals={0}
              duration={1}
              separator=","
            />
              ...
              <Flex sx={{ alignItems: "center", justifyContnet: "center" }}>
                ...
                <TooltipBubble
                  body={
                    <Text>
                      {t(
                        "Capital that Digidex has on hand to use for DAO expenses."
                      )}
                    </Text>
                  }
                  width="200px"
              ...
              <Flex sx={{ alignItems: "center", justifyContnet: "center" }}>
                ...
                <TooltipBubble
                  body={
                    <Text>
                      {t(
                        "Total value of the liquidity that ApeSwap owns in the form of LP tokens."
                      )}
                    </Text>
                  }
                  width="180px"
              ...
              <Flex sx={{ alignItems: "center", justifyContnet: "center" }}>
                ...
                <TooltipBubble
                  body={
                    <Text>
                      {t(
                        "Total value of the liquidity that ApeSwap Partners own in the form of LP tokens."
                      )}
                    </Text>
                  }
                  width="180px"
