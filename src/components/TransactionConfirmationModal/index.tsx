...
import { ChainId, Currency, Pair, Token } from "@digi.swap/sdk";
...
import { Modal, ModalProps } from "@digidexfinance/uikit";
      ...
      <AutoColumn gap="12px" justify="center">
            ...
            <RowFixed>
              <Text>
                {t(`Add %symbol% to Metamask`, {
                  symbol: currencyToAdd.getSymbol(chainId),
                })}
              </Text>
        ...
        {LpToAdd && library?.provider?.isMetaMask && (
          <Button
            ...
            onClick={() =>
              registerToken(
                LpToAdd?.liquidityToken?.address,
                getCleanLpSymbol(LpToAdd, chainId),
                18,
                ""
              )
            }
