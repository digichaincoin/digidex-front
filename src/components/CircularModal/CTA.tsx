...
const CTA_CARDS = {
  ...
  buyModal: {
    ...
    2: <CTACard type={CTA_TYPE.GDIGI} action={MODAL_TYPE.BUYING} />,
  },
  generalHarvestModal: {
    0: (
      <CTACard type={CTA_TYPE.MAXIMIZERS} action={MODAL_TYPE.GENERAL_HARVEST} />
    ),
    1: <CTACard type={CTA_TYPE.POOLS} action={MODAL_TYPE.GENERAL_HARVEST} />,
    2: <CTACard type={CTA_TYPE.GDIGI} action={MODAL_TYPE.GENERAL_HARVEST} />,
  },
  poolHarvestModal: {
    ...
    2: <CTACard type={CTA_TYPE.GDIGI} action={MODAL_TYPE.POOL_HARVEST} />,
  },
};
