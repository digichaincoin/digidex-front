...
import { Text, Flex, Checkbox, Button } from "@digi.swap/uikit";
...
const CircularModal: React.FC<MP> = ({
  actionType,
  description,
  supporting,
  children,
  ...
  const openLearnMore = () =>
    window.open(
      "https://digichain.gitbook.io/digidex-finance/welcome/apeswap-tokens/digichain#what-can-i-do-with-digichain",
      "_blank"
    );
