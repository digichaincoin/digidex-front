...
const LendingBody3: React.FC = () => {
  return (
    <ModalContent Icon={<StyledLendingM3Icon />}>
      <RightContent>
        <StyledText>
          Both suppliers and borrowers can earn DIGICHAIN rewards from the
          Rainmaker, depending on the market. <br />
          DIGICHAIN rewards are independent of interest earned/owed.
        </StyledText>
      </RightContent>
    </ModalContent>
  );
