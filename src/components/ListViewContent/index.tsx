...
import { Flex, HelpIcon } from "@digidexfinance/uikit";
import { TooltipBubble } from "@digi.swap/uikit";
  ...
  return (
    <ListViewContentContainer mb={mb} ml={ml} width={width} height={height}>
      ...
      <Flex alignItems="center" justifyContent={justifyContent}>
        ...
        {value2 && (
          <ValueText
            bold={!value2Secondary}
            value2Secondary={value2Secondary}
            lineHeight={lineHeight}
          >
            {value2.includes("NaN") ||
            value2.includes("undefined") ||
            value.includes("null") ? (
              <ValueSkeleton />
            ) : (
              value2
