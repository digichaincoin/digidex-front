...
import { Flex, Select, SelectItem, Text } from "@digidexfinance/uikit";
    ...
    <ControlContainer>
      ...
      <MobilePadding>
        <ToggleWrapper onClick={() => onSetStake(!stakedOnly)}>
          <StyledCheckbox
            checked={stakedOnly}
            onChange={() => onSetStake(!stakedOnly)}
          />
      ...
      {showMonkeyImage && isDark ? (
        <StyledImage src="/images/farm-night-farmer.png" alt="night-monkey" />
      ) : (
        <StyledImage src="/images/farm-night-farmer.png" alt="day-monkey" />
      )}
    </ControlContainer>
  );
};
