...
import { JSBI, Pair, Percent } from "@digi.swap/sdk";
import { Text, Card, Flex, CardProps, Button, Svg } from "@digi.swap/uikit";
              ...
              <FixedHeightRow onClick={() => setShowMore(!showMore)}>
                <RowFixed>
                  ...
                  <StyledText small color="gray">
                    ...
                    {currency1.getSymbol(chainId)} LP
                  </StyledText>
                </RowFixed>
                <RowFixed>
                  <Text>
      ...
      <Flex sx={{ ...styles.innerContainer }}>
        ...
        <Flex sx={{ alignItems: "center" }}>
          <Text mr="10px" weight={700}>
            {currencyPrice
              ? `$${(
                  currencyPrice * parseFloat(userPoolBalance?.toSignificant(4))
                ).toFixed(2)}`
              : "-"}
          </Text>
