...
import { MarketingModal } from "@digi.swap/uikit";
...
import GdigiModal from "components/GdigiModal";
...
const MarketingModalCheck = () => {
  ...
  */
  ...
  const getGdigiRoute = location.search.includes("modal=gdigi");
  ...
  moonpayRoute ? (
    ...
    <GdigiModal onDismiss={onDismiss} />
  ) : buyRoute ? (
