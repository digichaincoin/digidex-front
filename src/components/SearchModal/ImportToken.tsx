...
import { Token, Currency } from "@digi.swap/sdk";
import { Link, Tag } from "@digidexfinance/uikit";
import { Text, Flex, Button, Checkbox, ErrorIcon } from "@digi.swap/uikit";
    ...
    <Box className="boxCon" sx={{ padding: "20px 20px 20px 20px" }}>
      <Flex sx={{ flexDirection: "column" }}>
        <Text sx={{ textAlign: "center" }}>
          <h1 style={{ fontSize: "26px", color: "red", lineHeight: "35px" }}>
            ...
            <Box key={token.address} sx={{ marginTop: "24px" }}>
              ...
              {chainId && (
                <Flex>
                  ...
                  <Link
                    href={getEtherscanLink(token.address, "address", chainId)}
                    external
                  >
