...
import { Currency, Pair, Token } from "@digi.swap/sdk";
import {
  Button,
  Text,
  useModal,
...
const CurrencyInputContainer = styled.div<{
  ...
  padding: ${({ removeLiquidity }) =>
    removeLiquidity ? "25px 0px 40px 0px" : "45px 0px 25px 0px"};
  height: 263px;
  width: 330px;
  ${({ theme }) => theme.mediaQueries.md} {
