...
import { Navbar as UikitMenu, useModal } from "@digi.swap/uikit";
...
import { useDigichainPrice } from "state/tokenPrices/hooks";
...
const Menu = (props) => {
  ...
  const digichainPriceUsd = useDigichainPrice();
  ...
  return (
    <UikitMenu
      ...
      digichainPriceUsd={digichainPriceUsd}
      t={t}
      langs={languageList}
      setLang={setLanguage}
