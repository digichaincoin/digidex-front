...
import { Text, Flex, Input as NewInput } from "@digi.swap/uikit";
import { Input } from "@digidexfinance/uikit";
import {
...
const SlippageTabs: React.FC<SlippageTabsProps> = ({ zapSettings }) => {
  const [userSlippageTolerance, setUserSlippageTolerance] =
    useUserSlippageTolerance(zapSettings);
    ...
    <Flex sx={{ flexDirection: "column" }}>
      <Flex sx={{ flexDirection: "column", mb: "5px" }}>
        ...
        <Flex flexWrap="wrap">
          <SelectButton
            sx={{
              background: userSlippageTolerance === 10 ? "yellow" : "white3",
            }}
            onClick={() => {
              setSlippageInput("");
          ...
          <SelectButton
            sx={{
              background: userSlippageTolerance === 50 ? "yellow" : "white3",
            }}
            onClick={() => {
              setSlippageInput("");
          ...
          <SelectButton
            sx={{
              background: userSlippageTolerance === 100 ? "yellow" : "white3",
            }}
            onClick={() => {
              setSlippageInput("");
        ...
        {!!slippageError && (
          <Text
            weight={500}
            color={
              slippageError === SlippageError.InvalidInput ? "error" : "error"
            }
            mt="8px"
          >
            {slippageError === SlippageError.InvalidInput
