import { JSBI, Percent, Token, ChainId, WETH } from "@digi.swap/sdk";
...
export const MODAL_INFO = {
  sellModal: {
    title: "Selling DIGICHAIN?",
    supporting: "Before You Sell...",
    description: "Have you tried these products?",
  },
  buyModal: {
    title: "You've Got DIGICHAIN!",
    supporting: "Now You're Ready...",
    description: "Put your new DIGICHAIN to work!",
  },
  generalHarvestModal: {
    title: "You've Earned DIGICHAIN!",
    supporting: "Did You Know?",
    description: "You can use your DIGICHAIN to earn more rewards:",
  },
  poolHarvestModal: {
    title: "You've Earned DIGICHAIN!",
    supporting: "Did You Know?",
...
export const CTA_CARD_INFO = {
  maximizers: {
    ...
    destination: "https://digidex.finance/maximizers",
  },
  pools: {
    title: "Pools",
    description: "Discover the next gem",
    destination: "https://digidex.finance/pools",
  },
  lending: {
    title: "Lending",
    description: "Supply, borrow, and earn",
    destination: "https://lending.digidex.finance",
  },
  gdigi: {
    title: "Gdigi",
    description: "Unlock exclusive utility",
    destination: "https://digidex.finance/gdigi",
  },
  compound: {
    title: "Compound",
