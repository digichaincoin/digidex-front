...
import { ChainId, SmartRouter } from "@digi.swap/sdk";
...
export const NETWORK_INFO_LINK = {
  [ChainId.BSC]: "https://info.digidex.finance",
  [ChainId.BSC_TESTNET]: "https://info.digidex.finance",
  [ChainId.MATIC]: "https://polygon.info.digidex.finance/",
  [ChainId.MATIC_TESTNET]: "https://polygon.info.digidex.finance/",
  [ChainId.MAINNET]: "https://ethereum.info.digidex.finance",
};
...
// Digi price impact cutoff
export const DIGI_PRICE_IMPACT = 15;

// This sets the priority of when a router is used
// After DIGI router should be in order of highest liquidity
export const PRIORITY_SMART_ROUTERS = {
  ...
  [ChainId.BSC]: [SmartRouter.DIGI, SmartRouter.PANCAKE, SmartRouter.BISWAP],
  [ChainId.MATIC]: [SmartRouter.DIGI, SmartRouter.QUICKSWAP],
  [ChainId.BSC_TESTNET]: [SmartRouter.DIGI],
};
...
export const SMART_PRICE_GETTERS = {
  [ChainId.BSC]: {
    [SmartRouter.DIGI]: "0x5e545322b83626c745FE46144a15C00C94cBD803",
  ...
  [ChainId.BSC_TESTNET]: {
    [SmartRouter.DIGI]: "0xd722f9A2950E35Ab3EeD1d013c214671750A638B",
  },
  [ChainId.MATIC]: {
    [SmartRouter.DIGI]: "0x05D6C73D7de6E02B3f57677f849843c03320681c",
    [SmartRouter.QUICKSWAP]: "0xEe57c38d678CaE0cE16168189dB47238d8fe6553",
  },
  [ChainId.MAINNET]: {
    [SmartRouter.DIGI]: "0x5fbFd1955EeA2F62F1AfD6d6E92223Ae859F7887",
